...
void RiverSide::Init()
{
	if (!m_spModel)
	{
		...
		m_spModel->SetModelData(KdAssets::Instance().m_modeldatas.GetData("Asset/Models/SphereDome/RiverSide/RiverSide.gltf"));
	}
